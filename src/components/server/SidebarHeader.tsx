    ...
    return (
        <DropdownMenu>
            ...
            <DropdownMenuContent className="w-56 text-xs font-medium text-black dark:text-neutral-400 space-y-[2px]">
                {isModerator && (
                    <DropdownMenuItem className="hover:text-indigo-400 transition hover:bg-zinc-700/10 dark:hover:bg-zinc-700/50 hover:outline-none flex items-center text-indigo-600 dark:text-indigo-400 px-3 py-2 text-sm cursor-pointer">
                        Invite people
